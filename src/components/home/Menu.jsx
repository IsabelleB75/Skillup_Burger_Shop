...
burgerSrc={burger1} price={200}
title="Cheese Burger" handler={addToCartHandler } delay={0.1}
/> <MenuCard
itemNum={2
}
burgerSrc={burger2
} price={500} title="Cheese Burger vegane" delay={0.5} handler={addToCartHandler }
/> <MenuCard
itemNum={3
}
burgerSrc={burger3
} price={1800}
title="Cheese Burger avec frites" delay={0.8} handler={addToCartHandler}
         />
       </div>
     </section>
); };
